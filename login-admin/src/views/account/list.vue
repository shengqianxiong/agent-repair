<template>
  <div class="page-card">
    ...
    <div class="table-toolbar">
      <span>账号列表</span>
      <el-button type="primary" @click="goAdd">新增账号</el-button>
    </div>
...
function isCurrentAccount(id) {
  return currentAccountId !== null && Number(id) === Number(currentAccountId)
}
...
function goEdit(id) {
  router.push({ path: '/account/edit', query: { id } })
}
