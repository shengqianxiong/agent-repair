-- RealCloudAgent-PR-1780773063566 极简登录模块 DDL
-- 数据库：travel
...
CREATE TABLE `admin_user` (
    ...
    `password`    VARCHAR(64)  NOT NULL COMMENT '登录密码（MD5 摘要）',
