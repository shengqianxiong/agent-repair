...
let cachedBaijiahaoConfig: HumanConfig | null = null
...
export function getBaijiahaoHumanConfig(): HumanConfig {
  if (cachedBaijiahaoConfig) return cachedBaijiahaoConfig
  cachedBaijiahaoConfig = buildHumanConfig('BAIJIAHAO', {
    base: 1400,
    afterLoadDelay: 7000,
    beforePublishDelay: 4500,
    chunkPauseMin: 800,
    chunkPauseMax: 1800,
    typeDelayMin: 90,
    typeDelayMax: 190,
  })
  return cachedBaijiahaoConfig
}
